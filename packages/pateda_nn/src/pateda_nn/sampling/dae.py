...
from pateda_nn.learning.dae import DenoisingAutoencoder, MultiLayerDAE, corrupt_binary
...
def sample_categorical_dae(
    ...
    from pateda_nn.learning.dae import CategoricalDAE, corrupt_categorical
