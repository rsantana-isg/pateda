...
from pateda_nn.learning.discrete_dbd import BinaryDeblendingNet, CategoricalDeblendingNet
...
def sample_binary_dbd_uc(
    ...
    with torch.no_grad():
        ...
        from pateda_nn.learning.discrete_dbd import sample_from_univariate_binary
...
def sample_binary_dbd_cs_t(
    ...
    from pateda_nn.learning.discrete_dbd import transform_binary_to_continuous
...
def sample_binary_dbd_uc_t(
    ...
    from pateda_nn.learning.discrete_dbd import sample_from_univariate_binary, compute_conditional_probabilities, transform_binary_to_continuous
