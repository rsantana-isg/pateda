...
from pateda_nn.learning.discrete_dendiff_ste import (
...
from pateda_nn.learning.discrete_dendiff_utils import binarize_samples

# Try to import enhanced versions with fitness guidance support
try:
    from pateda_nn.learning.discrete_dendiff_gumbel_enhanced import (
        FitnessGuidedDiscreteDenoisingMLP
    )
    from pateda_nn.learning.discrete_dendiff_corruption_enhanced import (
        FitnessGuidedCorruptionDenoisingMLP
    )
    from pateda_nn.learning.discrete_dendiff_deterministic_enhanced import (
        FitnessGuidedDeterministicDenoisingMLP
    )
    from pateda_nn.learning.discrete_dendiff_ste_enhanced import (
        FitnessGuidedSTEDenoisingMLP
    )
    from pateda_nn.learning.discrete_dendiff_hard_concrete_enhanced import (
