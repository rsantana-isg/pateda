...
from pateda_nn.learning.discrete_backdrive import DiscreteBackdriveNet
from pateda_nn.learning.discrete_backdrive_descriptors import DescriptorBackdriveNet
...
def sample_binary_vae(
    ...
    if use_fitness_guidance and model.get('type') == 'binary_evae':
        from pateda_nn.learning.discrete_vae import FitnessPredictor
...
def sample_binary_gan_cond_fit(
    ...
    from pateda_nn.learning.discrete_gan import ConditionalBinaryGANGenerator
...
def sample_binary_gan_aux(
    ...
    from pateda_nn.learning.discrete_gan import BinaryGANGenerator, BinaryAuxGANDiscriminator
...
def sample_binary_gan_hybrid_vae(
    ...
    from pateda_nn.learning.discrete_gan import BinaryGANGenerator, BinaryGANEncoder
