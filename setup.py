...
setup(
    ...
    install_requires=[
        ...
        "scipy>=1.7.0",
        "pandas>=1.3.0",
        # Bayesian-network EDAs (BOA, EBNA) delegate learning/sampling to
        # bayes_nets (replaces the former pgmpy use). Install the in-development
        # package with: pip install -e edas_bayes_nets
        "bayes_nets>=0.1.0",
        "networkx>=2.6.0",
        "scikit-learn>=1.0.0",
        "matplotlib>=3.4.0",
