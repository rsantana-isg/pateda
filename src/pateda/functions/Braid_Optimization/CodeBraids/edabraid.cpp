...
Quaternion Target = (Quaternion){-1,0,0,0};
unsigned int Card=4;
#endif
...
void InitBraids(){    	
	Generators = (Quaternion*)malloc(sizeof(Quaternion)*16);    
  	#ifndef FAKE_QUATERNIONS
	Complex sqrt2Inv = (Complex){1.0/sqrt(2), 0};
	Complex twoOverRoot2 = (Complex){2.0/sqrt(2), 0};
	Generators[0] = (Quaternion){I,Z,Z,Z, Z,I,Z,Z, Z,Z,U,Z, Z,Z,Z,U};
	Quaternion_Scale(sqrt2Inv, (Quaternion){U,Z,I,Z, Z,U,Z,I, I,Z,U,Z, Z,I,Z,U},&Generators[1]);
	Generators[2] = (Quaternion){I,Z,Z,Z, Z,U,Z,Z, Z,Z,U,Z, Z,Z,Z,I};
        Quaternion_Scale(sqrt2Inv, (Quaternion){U,I,Z,Z, I,U,Z,Z, Z,Z,U,minusI, Z,Z,minusI,U},&Generators[3]);
	Generators[4] = (Quaternion){I,Z,Z,Z, Z,U,Z,Z, Z,Z,I,Z, Z,Z,Z,U};

	Generators[5] = (Quaternion){minusI,Z,Z,Z, Z,minusI,Z,Z, Z,Z,U,Z, Z,Z,Z,U};
        Quaternion_Scale(sqrt2Inv, (Quaternion){U,Z,minusI,Z, Z,U,Z,minusI, minusI,Z,U,Z, Z,minusI,Z,U},&Generators[6]);
	Generators[7] = (Quaternion){minusI,Z,Z,Z, Z,U,Z,Z, Z,Z,U,Z, Z,Z,Z,minusI};
        Quaternion_Scale(sqrt2Inv, (Quaternion){U,minusI,Z,Z, minusI,U,Z,Z, Z,Z,U,I, Z,Z,I,U},&Generators[8]);
	Generators[9] = (Quaternion){minusI,Z,Z,Z, Z,U,Z,Z, Z,Z,minusI,Z, Z,Z,Z,U};
	...
	Quaternion_Conjugate(Generators[1],&Generators[3]);
        //Target = Quaternion_FromAxisAngleBurrello(-1.0,tau,0.0,phi);
        //Target = Quaternion_FromAxisAngle(-1.0,tau,0.0,phi);
...
void evalcondensed(Popul* epop,int nelit, int epsize, int atgen)
{
 ...
 {  
  ...
  if(func==3 || func==7)
	...
	for(j=0; j<=alength;  j++)   epop->P[k][j] = auxbraid[j];   //NOTICE HERE THAT j<=alength     
...
int main( int argc, char *argv[] )
{
  ...
  //./edabraid 30 1 1 50 500 50 50 1 1000 3 0 0 0 1 0
...
int i, T,u,MaxMixtP,S_alph,Compl; 
 ...
 printvals  = atoi(argv[15]);    // The printvals-1 best values in each generation are printed 
 //Card =  atoi(argv[15]);
...
//
cout<<"Alg : 1 "<<", number codifying bits : "<<length<<", n : "<<vars<<", psize : "<<psize<<", Trunc : "<<T<<", max-gen : "<<Maxgen<<", BestElit. : "<<BestElitism<<", NNeighbors  : "<<CliqMaxLength<<", MaxFun  : "<<Max<<", func : "<<func<<" Card: "<<Card<<endl; 
