...
{ 
 ...
 //if(legalconf>20) cout<<"This is an example "<<legalconf<<" "<<NumberVars<<endl;
...
{     
	...
	{      
		...
		while (auxmemberlist != (memberlistclique*)0)   
		{   
                   othermemberlist = auxmemberlist->nextcliq;   
		   delete auxmemberlist;   
		   auxmemberlist = othermemberlist;   
		}   
		   
	}   
	for(i=0;i<NumberCliques;i++) delete ListCliques[i];   
...
{   
  ...
  clique* newcliq;   
      ...
      newcliq = new clique(allnodes[1]-1,CliqueMaxLength);   
      NumberCliques++;   
  ...
  {   
      ...
      //cout<<" "<<allnodes[i]-1;   
      //if(i<nnodes) cout<<allnodes[i]<<",";
      //else  cout<<allnodes[i]<<"],";
     CliquesPerNodes[allnodes[i]-1] = new memberlistclique(NumberCliques-1,CliquesPerNodes[allnodes[i]-1]);      
    }   
  //cout<<endl;   
}   
