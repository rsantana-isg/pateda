		   ...
		   for (i=0;i<cantexp;i++) 
                ...
                if (succexp>0)  
                   {  
                    ...
                    cout<<"TypeExp="<<ExperimentMode<<" Func="<<func<<" KDec="<<KDec<<" Card="<<Card<<" n="<<vars<<" T="<<Trunc<<" N="<<psize<<" Sel="<<Tour<<"  TypeInfMethod="<<TypeInfMethod<<"  k="<<Cycles<<"  MaxGen="<<Maxgen<<"  Elit="<<Elit<<" Suc.="<<succexp<<"  g="<<(auxmeangen+1)<<"  ave="<<meanfit<<" meaneval "<<meaneval<<" sigma "<<sigma<<" timebest "<<bestalltime<<" fulltime "<<alltime<<endl;                   
                   } 
                  else  
                   {  
		      cout<<"TypeExp="<<ExperimentMode<<" Func="<<func<<" KDec="<<KDec<<" Card="<<Card<<" n="<<vars<<" T="<<Trunc<<" N="<<psize<<" Sel="<<Tour<<"  TypeInfMethod="<<TypeInfMethod<<"  k="<<Cycles<<"  MaxGen="<<Maxgen<<"  Elit="<<Elit<<" Suc.="<<0<<"  g="<<0<<"  ave="<<0<<" meaneval "<<meaneval<<" sigma "<<sigma<<" fulltime "<<alltime<<" Eval "<<(TotEvaluations/(1.0*cantexp))<<endl; 
                   } 
...
{  
  ...
  switch(algtype)  
		       ...
		       case 6: succ = RobustMNEDA(Complex,2); // Learns MN-EDA, MN-FDA, or MOA using MI and applying G-test after (Elitist MPC)
                       case 7: succ = RobustMNEDA(Complex,2); // Learns MN-EDA, MN-FDA, or MOA using MI and applying G-test after (Biased MPC)
                     } 
