...
public: 
  ...
  int  nNextMax;
   ...
   int totnumboptint;
   int optmatrix[23][23];
   double energymatrix[15][15];
   int freqmatrix[15][15]; 
   ...
   //Auxiliary arrays
    ...
    HPProtein(int,int*);
    HPProtein(int,int*,double,double,int); 
virtual   ~HPProtein();
...
virtual   double ContactOrderVector(int,int*,unsigned int*);   
virtual   double ContactOrderChain(int,int*,int**);   
virtual   int    CompactnessVector(int,unsigned int*);   
virtual   int    Compactness(int, int**);   
virtual void CollectStat(int, unsigned int*, double**);  
virtual int VectorContactMatrix(int,unsigned int*,double**);
virtual int CreateContactMatrix(int,int**,double**);
virtual void FindFreq(int, int**,double**);
