...
from pateda.learning.nn_eda import FitnessWeightedAutoencoder
...
def sample_nn_eda_hybrid(
    ...
    1. Best solutions found during training (exploitation)
    2. New solutions generated by the autoencoder (exploration)
    ...
    if n_to_generate > 0:
        new_samples = sample_nn_eda(model_data, n_to_generate, params=params)
