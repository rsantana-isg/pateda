...
if __name__ == '__main__':        
	#obj_functions = ['OneMax', 'KDeceptive3', 'Deceptive3', 'HIFF', 'KDeceptive5', 'FC5']
        ...
        NN_EDAs = ['VAE','GAN', 'Backdrive', 'Backdrive-Random', 'Backdrive-PerturbBest', 'Backdrive-PerturbSelected', 'Backdrive-Adaptive', 'DAE', 'RBM', 'DbD','UMDA', 'TreeEDA', 'EBNA', 'MOA','MN-FDA', 'MN-FDAG', 'MK-EDA1', 'MK-EDA2', 'MK-EDA3','MT-EDA2', 'MT-EDA3']
