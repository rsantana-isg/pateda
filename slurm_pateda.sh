...
echo   "bnd -exec python3 $1 $2 $3 $4 $5 $6 $7 > results_discrete_eda_$3_$4_$5_$6_$7_$2.dat"        
        bnd -exec python3 $1 $2 $3 $4 $5 $6 $7 > results_discrete_eda_$3_$4_$5_$6_$7_$2.dat
